...
$cmake -B lib2geom-build -S lib2geom -GNinja -DCMAKE_INSTALL_PREFIX=lib2geom-build/install
$cmake --build lib2geom-build --target install
lib2geom_path="lib2geom-build/install/lib/cmake"
