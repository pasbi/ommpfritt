...
public:
  ...
  [[nodiscard]] QModelIndex mapToChainSource(const QModelIndex& index) const;
  [[nodiscard]] QModelIndex mapFromChainSource(const QModelIndex& index) const;
  ...
  [[nodiscard]] QAbstractProxyModel& sub_proxy(std::size_t i) const;
  [[nodiscard]] QAbstractItemModel* chainSourceModel() const;
