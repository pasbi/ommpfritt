  ...
  : ManagerTitleBar(parent)
{
  ...
  python_menu->addAction(app.key_bindings.make_action(parent, "clear console").release());
  python_menu->addAction(app.key_bindings.make_action(parent, "evaluate").release());
